 ...
 **материалы и инструменты**
 ...
 ![stol](./assets/images/led_rgb/stol.jpg)
 
 Нам понадобится:
 
 Распечатанные модели держателей ленты  [тыц](./assets/stl/led_rgb/2_long_190mm.stl) и [тыц](./assets/stl/led_rgb/1_long_190mm.stl)  
...
![фото косы](./assets/images/led_rgb/kosa.jpg)
![фото косы2](./assets/images/led_rgb/kosa1.jpg)
...
**что получилось в итоге**
 ...
 ![вид](./assets/images/led_rgb/fly_panda.jpg)
 
 ![видео](./assets/images/led_rgb/party.gif)
