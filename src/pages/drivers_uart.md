...
копируем файл [tmc.cfg](./assets/cfg/drivers_uart/tmc.cfg) в папку  клиппера рядом с `printer.cfg` 
...
![1](./assets/images/drivers_uart/1.jpg)
![2](./assets/images/drivers_uart/2.jpg)
![3](./assets/images/drivers_uart/3.jpg)
![4](./assets/images/drivers_uart/4.jpg)

если все сделать правильно,получится как то так:

![5](./assets/images/drivers_uart/itog.jpg)
