...
8.   [**Перевод стола на 220V**](/bed220.md)
быстро греем стол медвежонка
...
Если не запустился сразу *покупной* экран 5 или 7 дюймов.
      ...
      2. **Клипперскрин** подключение штатного экрана по [этому мануалу](https://sergey1560.github.io/fb4s_howto/mks_ts35/) в родном мануале совсем невнятная схема подключения [тут](TS35%20Klipper.pdf) тоже самое но чуть понятнее. [**Плата для подключения штатными проводами экрана к вашей PI**](https://github.com/evgs/kross-pi-hat)
