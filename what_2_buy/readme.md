...
**Аdvanced** *продвинутый от начального*
 ...
 В этом разделе будут товары которые необязательно покупать, но которые существенно или не очень улучшают принтер вне зависимости от прошивки. Например:
  ...
  10. **Провода AWG24** Я лично уже заменил из-за своей криворукости, но мне писали что есть проблемы не только у меня. Для замены проводов мне понадобилось около 8 метров чтобы заменить 6 проводов которые идут к плате на фидере. еще 4 провода идут к мотору. итого я рекомендую купить 4 раза по 5 метров по [этой ссылке.](https://alii.pub/6j28ox) Рекомендую 1 красный 1 синий и 2 черных. по 5 метров каждый.
