...
В данном графике с помощью акселерометра тестируются ремни моторов А(X) и В(Y) цель полчуть максимально совпадающие линии ремней- это сначит ремни наятнуты одинаково, и привести к максимально похожему на один пик - минимальные вибрации 
